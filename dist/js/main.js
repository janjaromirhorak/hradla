...
var App = function () {
    ...
    function App(canvas, gridSize) {
        ...
        this.simulation = new _Simulation.SimulationDummy(); // dummy, will be overwritten on startNewSimulation
...
exports.SimulationDummy = undefined;
...
var SimulationDummy = exports.SimulationDummy = function () {
    function SimulationDummy() {
        _classCallCheck(this, SimulationDummy);
    }
...
var Simulation = function () {
     ...
     */
    function Simulation(appInstance) {
            ...
            try {
                for (var _iterator = this.waves.get(this.wave)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    */
                    ...
                    var connector = this.appInstance.getConnectorById(connectorId);
                    if (connector) {
...
},{"./Logic":12}],14:[function(require,module,exports){
'use strict';
...
},{"./editorElements/Blackbox":15,"./editorElements/Gate":18,"./editorElements/HelperWire":19,"./editorElements/InputBox":20,"./editorElements/InputConnector":21,"./editorElements/OutputBox":23,"./editorElements/OutputConnector":24,"./editorElements/Transform":25,"./editorElements/Wire":26}],15:[function(require,module,exports){
'use strict';
...
},{"../Logic":12,"../svgObjects":32,"./Box":16}],16:[function(require,module,exports){
'use strict';
...
var Box = function (_NetworkElement) {
     ...
     */
    function Box(appInstance, name, category, gridWidth, gridHeight) {
         ...
         * @type {string}
         */
        var _this = _possibleConstructorReturn(this, (Box.__proto__ || Object.getPrototypeOf(Box)).call(this, appInstance));
         ...
         * @type {number}
         */
        _this.gridSize = _this.appInstance.gridSize;
    ...
    _createClass(Box, [{
        ...
        value: function addConnector(left, top, isInputConnector) {
            ...
            if (isInputConnector) {
                this.connectors[index] = new _InputConnector2.default(this.appInstance, left, top);
            } else {
                this.connectors[index] = new _OutputConnector2.default(this.appInstance, left, top);
            }
        ...
        value: function onMouseDownLeft(event) {
            ...
            var _appInstance$viewbox$ = this.appInstance.viewbox.transformEvent(event),
                pageX = _appInstance$viewbox$.pageX,
                pageY = _appInstance$viewbox$.pageY;
        ...
        value: function onMouseMove(event) {
            if (this.mouseLeft) {
                ...
                var _appInstance$viewbox$2 = this.appInstance.viewbox.transformEvent(event),
                    pageX = _appInstance$viewbox$2.pageX,
                    pageY = _appInstance$viewbox$2.pageY;
        ...
        value: function onDrop(event) {
            var _appInstance$viewbox$3 = this.appInstance.viewbox.transformEvent(event),
                pageX = _appInstance$viewbox$3.pageX,
                pageY = _appInstance$viewbox$3.pageY;
        ...
        value: function updateWires() {
            ...
            this.connectors.forEach(function (conn) {
                conn.wireIds.forEach(function (wireId) {
                    var wire = _this2.appInstance.getWireById(wireId);
                    if (temporary) {
                        wire.temporaryWire();
                    } else {
                        wire.routeWire();
...
},{"../svgObjects":32,"./InputConnector":21,"./NetworkElement":22,"./OutputConnector":24,"./Transform":25}],17:[function(require,module,exports){
'use strict';
...
var Connector = function (_NetworkElement) {
   ...
   */
  function Connector(appInstance, left, top) {
     ...
     * @type {number}
     */
    var _this = _possibleConstructorReturn(this, (Connector.__proto__ || Object.getPrototypeOf(Connector)).call(this, appInstance));

    _this.gridSize = appInstance.gridSize;
    /**
     * size of the connector in SVG pixels
     * @type {number}
     */
    _this.connectorSize = appInstance.gridSize;
    /**
...
},{"../Logic":12,"../svgObjects":32,"./NetworkElement":22,"./stateClasses":27}],18:[function(require,module,exports){
'use strict';
...
var Gate = function (_Box) {
     ...
     */
    function Gate(appInstance, name) {
...
},{"../Logic":12,"./Box":16}],19:[function(require,module,exports){
'use strict';
...
var HelperWire = function (_NetworkElement) {
    ...
    function HelperWire(appInstance, fromId, mousePosition) {
        _classCallCheck(this, HelperWire);

        var _this = _possibleConstructorReturn(this, (HelperWire.__proto__ || Object.getPrototypeOf(HelperWire)).call(this, appInstance));

        var connector = _this.appInstance.getConnectorById(fromId);
        _this.connectorPosition = _this.appInstance.getConnectorPosition(connector, true);
...
},{"../svgObjects":32,"./NetworkElement":22}],20:[function(require,module,exports){
'use strict';
...
},{"../Logic":12,"./Box":16}],21:[function(require,module,exports){
'use strict';
...
var InputConnector = function (_Connector) {
   ...
   * @param {number} top       vertical position defined in grid units (SVG pixels divided by the grid size)
   */
  function InputConnector(appInstance, left, top) {
    _classCallCheck(this, InputConnector);

    var _this = _possibleConstructorReturn(this, (InputConnector.__proto__ || Object.getPrototypeOf(InputConnector)).call(this, appInstance, left, top));
  ...
  _createClass(InputConnector, [{
    ...
    value: function setState(state) {
      ...
      var box = this.appInstance.getBoxByConnectorId(this.svgObj.id);
      box.refreshState();
    }
...
},{"../Logic":12,"./Connector":17}],22:[function(require,module,exports){
"use strict";
...
var NetworkElement = function () {
   ...
   */
  function NetworkElement(appInstance) {
...
var OutputBox = function (_Box) {
     ...
     * @param {App} appInstance  instance of [App](./module-App.html)
     */
    function OutputBox(appInstance) {
...
},{"../Logic":12,"./Box":16}],24:[function(require,module,exports){
'use strict';
...
var OutputConnector = function (_Connector) {
     ...
     * @param {number} top       vertical position defined in grid units (SVG pixels divided by the grid size)
     */
    function OutputConnector(appInstance, left, top) {
        _classCallCheck(this, OutputConnector);

        var _this = _possibleConstructorReturn(this, (OutputConnector.__proto__ || Object.getPrototypeOf(OutputConnector)).call(this, appInstance, left, top));
...
var Wire = function (_NetworkElement) {
     ...
     */
    function Wire(appInstance, fromId, toId) {
        var refresh = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
        var route = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;

        _classCallCheck(this, Wire);

        var _this = _possibleConstructorReturn(this, (Wire.__proto__ || Object.getPrototypeOf(Wire)).call(this, appInstance));
        ...
        _this.connection = {
            from: {
                id: fromId,
                box: _this.appInstance.getBoxByConnectorId(fromId),
                connector: _this.appInstance.getConnectorById(fromId)
            },
            to: {
                id: toId,
                box: _this.appInstance.getBoxByConnectorId(toId),
                connector: _this.appInstance.getConnectorById(toId)
            }
        };
    ...
    _createClass(Wire, [{
        ...
        value: function findRoute(start, end) {
            var nonRoutable = this.appInstance.getNonRoutableNodes();
        ...
        value: function generateInconvenientNodes() {
            ...
            this.points.forEach(function (point) {
                var x = _this2.appInstance.SVGToGrid(point.x),
                    y = _this2.appInstance.SVGToGrid(point.y);

                if (prevPoint === undefined) {
                    // if the prevPoint is undefined, add the first point
                    _this2.inconvenientNodes.add({ x: x, y: y });
                } else {
                    ...
                    if (prevPoint.x === x) {
                        ...
                        while (from <= to) {
                            _this2.inconvenientNodes.add({ x: x, y: from });
                            from++;
                        }
                        ...
                        while (_from <= _to) {
                            _this2.inconvenientNodes.add({ x: _from, y: y });
                            _from++;
                        }
                    } else {
...
},{"../Logic":12}],28:[function(require,module,exports){
'use strict';
...
},{"./Tag":42}],34:[function(require,module,exports){
'use strict';
...
},{"./SvgElement":40}],40:[function(require,module,exports){
'use strict';
...
var GateMenuItem = function (_ContextMenuItem) {
    ...
    function GateMenuItem(type, contextMenu) {
        ...
        return _this3 = _possibleConstructorReturn(this, (GateMenuItem.__proto__ || Object.getPrototypeOf(GateMenuItem)).call(this, type.toUpperCase() + ' gate', contextMenu, function () {
            _this3.appInstance.newGate(type, _this3.appInstance.snapToGrid(_this3.appInstance.viewbox.transformX(contextMenu.position.x)), _this3.appInstance.snapToGrid(_this3.appInstance.viewbox.transformY(contextMenu.position.y)));
        }));
    }
    ...
    function BlackboxMenuItem(name, file, contextMenu) {
        ...
        return _this4 = _possibleConstructorReturn(this, (BlackboxMenuItem.__proto__ || Object.getPrototypeOf(BlackboxMenuItem)).call(this, name, contextMenu, function () {
            (0, _networkLibrary.getNetworkFromLibrary)(file).then(function (_ref) {
                ...
                _this4.appInstance.newBlackbox(inputs, outputs, table, usedName, _this4.appInstance.snapToGrid(_this4.appInstance.viewbox.transformX(contextMenu.position.x)), _this4.appInstance.snapToGrid(_this4.appInstance.viewbox.transformY(contextMenu.position.y)));
    ...
    function NetworkMenuItem(name, file, contextMenu) {
        ...
        return _this5 = _possibleConstructorReturn(this, (NetworkMenuItem.__proto__ || Object.getPrototypeOf(NetworkMenuItem)).call(this, name, contextMenu, function () {
            (0, _networkLibrary.getNetworkFromLibrary)(file).then(function (data) {
                _this5.appInstance.importData(data, Math.round(_this5.appInstance.viewbox.transformX(contextMenu.position.x) / _this5.appInstance.gridSize), Math.round(_this5.appInstance.viewbox.transformY(contextMenu.position.y) / _this5.appInstance.gridSize)).then(function (warnings) {
                    var _iteratorNormalCompletion = true;
                    var _didIteratorError = false;
                    var _iteratorError = undefined;
                    ...
                    try {
                        for (var _iterator = warnings[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            ...
                            _this5.appInstance.messages.newWarningMessage(warning);
                        }
                    } catch (err) {
                        _didIteratorError = true;
                        _iteratorError = err;
                ...
                _this5.appInstance.messages.newErrorMessage(error);
            });
        }));
    }
...
var ContextMenu = function () {
     ...
     */
    function ContextMenu(appInstance) {
        var _this6 = this;
        ...
        this.appendConditionalItem('box', 'Remove this item', function (id) {
            _this6.appInstance.removeBox(id);
        });
        this.appendConditionalItem('wire', 'Remove this wire', function (id) {
            _this6.appInstance.removeWireById(id);
        });
        ...
        value: function displayImportDialog() {
            ...
            $popup.append($textblock).append($("<a>").attr({
                ...
                if (data) {
                    ...
                    _this7.appInstance.importData(data, Math.round(_this7.appInstance.viewbox.transformX(_this7.position.x) / _this7.appInstance.gridSize), Math.round(_this7.appInstance.viewbox.transformY(_this7.position.y) / _this7.appInstance.gridSize)).then(function (warnings) {
                        var _iteratorNormalCompletion4 = true;
                        var _didIteratorError4 = false;
                        var _iteratorError4 = undefined;
                        ...
                        try {
                            for (var _iterator4 = warnings[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                                ...
                                _this7.appInstance.messages.newWarningMessage(warning);
                            }
                        } catch (err) {
                            _didIteratorError4 = true;
                            _iteratorError4 = err;
 ...
 */
function FloatingButton(buttonClass, tooltip, clickEvent, appInstance) {
    var _this = this;
...
var FloatingMenu = function () {
     ...
     */
    function FloatingMenu(appInstance) {
...
var Tutorial = function () {
     ...
     */
    function Tutorial(appInstance, onTutorialClosed) {
        var _this = this;
    ...
    _createClass(Tutorial, [{
        ...
        value: function stepFinish() {
            ...
            this.windowChoice({
                ...
                func: function func() {
                    _this11.appInstance.cleanCanvas();
                    _this11.stop();
                }
            }, {
